...
class MLMDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        caption_tokenized = self.tokenizer(caption, max_length=77, truncation=True, padding='max_length', return_tensors='pt')
        
        mlm_tokens, mlm_labels = self.collator.torch_mask_tokens(caption_tokenized['input_ids'])
        ...
        return {
            ...
            'image_ids': image_id,
            'pixel_values': img,
            'input_ids': caption_tokenized['input_ids'].squeeze(0), # type: ignore
            'attention_mask': caption_tokenized['attention_mask'].squeeze(0), # type: ignore
